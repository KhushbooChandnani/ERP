...
<span class="required"> * </span>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    <label class="control-label col-md-2">Additional Specifications <span class="required"> * </span></label>
                    <div class="col-md-8">
                        <textarea name="additional_specification" id="additional_specification" rows="5" class="form-control" placeholder="Additional Specification"></textarea>
                   </div>
                </div>
            </div>
    ...
    <div class="form-actions">
        <div class="row">
            <div class="col-md-offset-3 col-md-9">
                <button type="submit" class="btn green" name="add_product" id="add_product">Save</button>
            </div>
        </div>
    </div>
</form>
