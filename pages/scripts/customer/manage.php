...
if(isset($_POST["search"]["value"])){
    $query .= " AND (customer.customer_name like '%".$_POST["search"]["value"]."%' OR customer.customer_email like '%".$_POST['search']['value']."%' OR customer.customer_contact like '%".$_POST['search']['value']."%')"; 
}
