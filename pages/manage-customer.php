...
<span class="required"> * </span>
                            ...
                            <div class="col-md-9">
                                    <textarea name="customer_address" id="customer_address" cols="30" rows="10"></textarea>
                            </div>
                            </div>
                            <div class="form-group clearfix">
...
<![endif]-->
    ...
    toastr["success"]("You edited successfully!!", "Customer Edit!!!")
    </script>
        <?php 
    ...
    toastr["success"]("You deleted successfully!!", "Customer Deleted!!!")
    </script>
        <?php 
        unset($_SESSION['status']);
        }
